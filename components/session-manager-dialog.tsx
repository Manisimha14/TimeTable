  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[90vh] gap-0 overflow-hidden p-0 sm:max-w-2xl">
        <DialogHeader className="border-b border-border bg-card p-5 text-left sm:p-6">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <DialogTitle className="font-display text-lg font-bold tracking-tight text-foreground sm:text-xl flex items-center gap-2">
            ...
            {totalUnloggedCount > 0 ? (
              <span className="inline-flex items-center gap-1.5 rounded-full bg-amber-500/10 px-3 py-1 text-xs font-bold text-amber-600 dark:text-amber-400">
                ...
                {totalUnloggedCount} unlogged session{totalUnloggedCount === 1 ? '' : 's'}
              </span>
            ) : (
          ...
          {metrics.isBelow80 && (
            <div className="mt-3 flex flex-col gap-2.5 rounded-xl border-2 border-destructive/40 bg-destructive/10 p-3.5 text-destructive">
              <div className="flex items-center justify-between">
                <span className="font-display text-xs font-bold flex items-center gap-1.5 text-destructive">
                  ...
                  Attendance Below 80% · Emundhi Le... Inka Paduko 😴
                </span>
        ...
        {/* List Content */}
        <ScrollArea className="max-h-[50vh] p-5 sm:p-6">
